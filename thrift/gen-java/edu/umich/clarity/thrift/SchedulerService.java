...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2015-7-10")
public class SchedulerService {
  ...
  public interface Iface {
    ...
    public int warmupCount() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void warmupCount(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_warmupCount() throws org.apache.thrift.TException
    {
      warmupCount_args args = new warmupCount_args();
      sendBase("warmupCount", args);
    }

    public int recv_warmupCount() throws org.apache.thrift.TException
    {
      warmupCount_result result = new warmupCount_result();
      receiveBase(result, "warmupCount");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "warmupCount failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void warmupCount(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      warmupCount_call method_call = new warmupCount_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class warmupCount_call extends org.apache.thrift.async.TAsyncMethodCall {
      public warmupCount_call(org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("warmupCount", org.apache.thrift.protocol.TMessageType.CALL, 0));
        warmupCount_args args = new warmupCount_args();
        args.write(prot);
        prot.writeMessageEnd();
      }
      ...
      public int getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_warmupCount();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("warmupCount", new warmupCount());
      return processMap;
    }
    ...
    public static class warmupCount<I extends Iface> extends org.apache.thrift.ProcessFunction<I, warmupCount_args> {
      public warmupCount() {
        super("warmupCount");
      }

      public warmupCount_args getEmptyArgsInstance() {
        return new warmupCount_args();
      }
      ...
      public warmupCount_result getResult(I iface, warmupCount_args args) throws org.apache.thrift.TException {
        warmupCount_result result = new warmupCount_result();
        result.success = iface.warmupCount();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class warmupCount<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, warmupCount_args, Integer> {
      public warmupCount() {
        super("warmupCount");
      }
      ...
      public void start(I iface, warmupCount_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.warmupCount(resultHandler);
      }
    }
...
;
  ...
  public static class warmupCount_args implements org.apache.thrift.TBase<warmupCount_args, warmupCount_args._Fields>, java.io.Serializable, Cloneable, Comparable<warmupCount_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("warmupCount_args");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new warmupCount_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new warmupCount_argsTupleSchemeFactory());
    }
...
;
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(warmupCount_args.class, metaDataMap);
    }

    public warmupCount_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public warmupCount_args(warmupCount_args other) {
    }

    public warmupCount_args deepCopy() {
      return new warmupCount_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof warmupCount_args)
        return this.equals((warmupCount_args)that);
      return false;
    }

    public boolean equals(warmupCount_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(warmupCount_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("warmupCount_args(");
      boolean first = true;
    ...
    private static class warmupCount_argsStandardSchemeFactory implements SchemeFactory {
      public warmupCount_argsStandardScheme getScheme() {
        return new warmupCount_argsStandardScheme();
      }
    }

    private static class warmupCount_argsStandardScheme extends StandardScheme<warmupCount_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, warmupCount_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, warmupCount_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class warmupCount_argsTupleSchemeFactory implements SchemeFactory {
      public warmupCount_argsTupleScheme getScheme() {
        return new warmupCount_argsTupleScheme();
      }
    }

    private static class warmupCount_argsTupleScheme extends TupleScheme<warmupCount_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, warmupCount_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, warmupCount_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
  ...
  public static class warmupCount_result implements org.apache.thrift.TBase<warmupCount_result, warmupCount_result._Fields>, java.io.Serializable, Cloneable, Comparable<warmupCount_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("warmupCount_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.I32, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new warmupCount_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new warmupCount_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(warmupCount_result.class, metaDataMap);
    }

    public warmupCount_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public warmupCount_result(warmupCount_result other) {
      __isset_bitfield = other.__isset_bitfield;
      this.success = other.success;
    }

    public warmupCount_result deepCopy() {
      return new warmupCount_result(this);
    }
    ...
    public warmupCount_result setSuccess(int success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof warmupCount_result)
        return this.equals((warmupCount_result)that);
      return false;
    }

    public boolean equals(warmupCount_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(warmupCount_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("warmupCount_result(");
      boolean first = true;
    ...
    private static class warmupCount_resultStandardSchemeFactory implements SchemeFactory {
      public warmupCount_resultStandardScheme getScheme() {
        return new warmupCount_resultStandardScheme();
      }
    }

    private static class warmupCount_resultStandardScheme extends StandardScheme<warmupCount_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, warmupCount_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, warmupCount_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class warmupCount_resultTupleSchemeFactory implements SchemeFactory {
      public warmupCount_resultTupleScheme getScheme() {
        return new warmupCount_resultTupleScheme();
      }
    }

    private static class warmupCount_resultTupleScheme extends TupleScheme<warmupCount_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, warmupCount_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, warmupCount_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
