...
public class QuerySpec implements org.apache.thrift.TBase<QuerySpec, QuerySpec._Fields>, java.io.Serializable, Cloneable, Comparable<QuerySpec> {
  ...
  private static final org.apache.thrift.protocol.TField FLOATING_BUDGET_FIELD_DESC = new org.apache.thrift.protocol.TField("floatingBudget", org.apache.thrift.protocol.TType.DOUBLE, (short)5);
  ...
  public double floatingBudget; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    FLOATING_BUDGET((short)5, "floatingBudget");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // BUDGET
          return BUDGET;
        case 5: // FLOATING_BUDGET
          return FLOATING_BUDGET;
        default:
          return null;
      }
    }
  ...
  private static final int __FLOATINGBUDGET_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.FLOATING_BUDGET, new org.apache.thrift.meta_data.FieldMetaData("floatingBudget", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    ...
    double floatingBudget)
  {
    ...
    this.budget = budget;
    setBudgetIsSet(true);
    this.floatingBudget = floatingBudget;
    setFloatingBudgetIsSet(true);
  }
  ...
  public QuerySpec(QuerySpec other) {
    ...
    this.floatingBudget = other.floatingBudget;
  }
  ...
  public void clear() {
    ...
    this.budget = 0.0;
    setFloatingBudgetIsSet(false);
    this.floatingBudget = 0.0;
  }
  ...
  public double getFloatingBudget() {
    return this.floatingBudget;
  }

  public QuerySpec setFloatingBudget(double floatingBudget) {
    this.floatingBudget = floatingBudget;
    setFloatingBudgetIsSet(true);
    return this;
  }

  public void unsetFloatingBudget() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FLOATINGBUDGET_ISSET_ID);
  }

  /** Returns true if field floatingBudget is set (has been assigned a value) and false otherwise */
  public boolean isSetFloatingBudget() {
    return EncodingUtils.testBit(__isset_bitfield, __FLOATINGBUDGET_ISSET_ID);
  }

  public void setFloatingBudgetIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FLOATINGBUDGET_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FLOATING_BUDGET:
      if (value == null) {
        unsetFloatingBudget();
      } else {
        setFloatingBudget((Double)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case FLOATING_BUDGET:
      return Double.valueOf(getFloatingBudget());
  ...
  public boolean equals(QuerySpec that) {
    ...
    boolean this_present_floatingBudget = true;
    boolean that_present_floatingBudget = true;
    if (this_present_floatingBudget || that_present_floatingBudget) {
      if (!(this_present_floatingBudget && that_present_floatingBudget))
        return false;
      if (this.floatingBudget != that.floatingBudget)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_floatingBudget = true;
    list.add(present_floatingBudget);
    if (present_floatingBudget)
      list.add(floatingBudget);
  ...
  public int compareTo(QuerySpec other) {
    ...
    lastComparison = Boolean.valueOf(isSetFloatingBudget()).compareTo(other.isSetFloatingBudget());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFloatingBudget()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.floatingBudget, other.floatingBudget);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("floatingBudget:");
    sb.append(this.floatingBudget);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class QuerySpecStandardScheme extends StandardScheme<QuerySpec> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, QuerySpec struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // FLOATING_BUDGET
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.floatingBudget = iprot.readDouble();
              struct.setFloatingBudgetIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QuerySpec struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(FLOATING_BUDGET_FIELD_DESC);
      oprot.writeDouble(struct.floatingBudget);
      oprot.writeFieldEnd();
