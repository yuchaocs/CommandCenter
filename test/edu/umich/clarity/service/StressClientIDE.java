...
/**
 * Created by hailong on 7/29/15.
 */
public class StressClientIDE {
    // common definition
    ...
    public static void main(String[] args) {
        ...
        StressClientIDE client = new StressClientIDE();
        if (OPERATION.equalsIgnoreCase("load")) {
            ...
            if (loadType.equalsIgnoreCase(StressClientIDE.LOAD_TYPE_BURST)) {
                client.genBurstLoad(num_client);
            } else if (loadType.equalsIgnoreCase(StressClientIDE.LOAD_TYPE_POISSON)) {
